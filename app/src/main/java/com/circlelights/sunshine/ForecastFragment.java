package com.circlelights.sunshine;

/**
 * Created by JasonAtPBWT on 12/26/14.
 */
    ...
    public class FetchWeatherTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=10025&mode=json&units=metric&cnt=7");
